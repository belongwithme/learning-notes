...
例图如下：  
![在这里插入图片描述](./assets/c6d33764f2e4891106f0ba0e.jpg)
...
1：入队  
![在这里插入图片描述](./assets/d6303e31b7f31d1f3322cd3a.jpg)  
2：出队  
注意，出队时front向上走一格，从-1到0，此时指向的数据已经被弹出（图中蓝色没去掉，但实际已经没有了）  
![在这里插入图片描述](./assets/505f56b2745551e7e05350ee.png)  
最后是判满或是判空：  
判满条件和判空条件对照图一看就明白了  
![在这里插入图片描述](./assets/d374f627ac01ee3ebe48e393.png)
...
栗子结构：  
![在这里插入图片描述](./assets/6bfc9bba0ffdfd565c1a0bd4.png)  
ArrayQueue代码：
