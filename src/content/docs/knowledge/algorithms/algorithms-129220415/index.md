...
* 链式：是用一组**任意的存储单元存储**线性表中的数据元素，称为线性表的链式存储结构。  
   ...
   ![在这里插入图片描述](./assets/a786ce817df01d4d09ec1640.png)  
   ![在这里插入图片描述](./assets/eb86a8b91950b18d8e9529e6.png)
...
队列的继承关系：  
 ![请添加图片描述](./assets/d01e81e199b63c28c27bf438.png)
...
* isEmpty()：判断队列是否为空![请添加图片描述](./assets/898e102c7f6bcacf881297e7.png)  
...
结果：  
 ![请添加图片描述](./assets/c1452a68fb95ab04bedc730e.png)
