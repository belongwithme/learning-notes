...
在图中找一棵包含图中所有节点的树, 且权重和最小的那棵树就叫最小生成树.  
 ...
 ![在这里插入图片描述](./assets/2b60cac0478a3ee93e72842e.png)
...
它也是使用贪心思想来让生成树的权重尽可能小,它采用切分的方式去处理.  
 ...
 举例:  
 ![在这里插入图片描述](./assets/42671503f33493e32c60939d.png)  
...
那代码如何实现呢?  
 ...
 ![在这里插入图片描述](./assets/c28e864e95e4ddb6b666cb2d.png)

是可以的,因为我们发现:  
  `cut({A, B, C}) = cut({A, B}) + cut({C})`  
 ![在这里插入图片描述](./assets/7f2ee6e7f734c04035a33c7f.png)  
