...
解析：  
 ...
 ![在这里插入图片描述](./assets/0b0bb20a517a26304826c098.png)
...
问题：程序被载入到内存之后，它会被划分为什么部分呢（假设只有一道用户程序）  
 答：如下图  
 ![在这里插入图片描述](./assets/50d8896ef65637500ae46fc7.png)那么我们怎么知道，在内存中进程的程序段和数据段在哪个位置？  
...
三：PCB中信息  
 ...
 ![在这里插入图片描述](./assets/09aeb3a496c66493e86e47a3.png)  
 四：PCB组织方式  
 我们知道，一个系统中PCB的数量非常之多，那么我们该如何管理PCB呢？  
 1：线性方式：所有PCB都在一张线性表中，表的起始地址存放在内存的一个专用区域里。  
 ![在这里插入图片描述](./assets/95bb1b7d40613a04720e7148.png)

2：链接方式：通过PCB中的链接字，具有相同状态的进程PCB链接成一个队列。  
 ![在这里插入图片描述](./assets/c062aba63c4da6dd1eab4981.png)

3：索引方式：根据进程状态不同，建立索引表，把索引表在内存中的起始地址记录在内存一些专用单元中。  
 ![在这里插入图片描述](./assets/b6c716f5bfad2e00c110f1ea.png)
...
3.阻塞状态：正在执行的进程由于发生某事件（IO请  
 ...
 ![在这里插入图片描述](./assets/9a8a56280f8e3a22c54a5738.png)
...
![在这里插入图片描述](./assets/f145651dce3721c7abf61cfb.png)
...
![在这里插入图片描述](./assets/bd73ab6f2d890a21bac9459a.png)  
...
![在这里插入图片描述](./assets/b6554ec43acd16fb0d26e9aa.png)
