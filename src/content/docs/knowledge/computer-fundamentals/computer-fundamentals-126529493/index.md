...
代码实现如下：  
![在这里插入图片描述](./assets/1d44bb20d7eeae9fabe07b61.png)  
...
代码实现：  
![在这里插入图片描述](./assets/5f3a3766912bcf3a126fb289.png)  
存在的问题：  
...
代码实现：  
![在这里插入图片描述](./assets/a9587ec009a3ec7689b8d52d.png)  
存在的问题：  
P0想进入，把P0改为了true；  
...
代码实现：  
![在这里插入图片描述](./assets/1cc5e8700eb41b5164f081ad.png)  
流程步骤举例：  
1.P0想进入，P0改为true；  
2.P1想进入，P1改为true；  
...
实现代码如下：  
![在这里插入图片描述](./assets/a0c8472c9831e323ebe8b805.png)  
...
代码实现：  
![在这里插入图片描述](./assets/0ff1969392b8693e72034f7a.png)  
...
实现如下：  
![在这里插入图片描述](./assets/b03aa58b2d0f1443d7b08833.png)  
我们可以看出，这里面还存在着让权等待。

2.记录型信号量  
在整形信号量（不满足让权等待）的基础上进行改进，使用记录型数据结构表示信号量：  
![在这里插入图片描述](./assets/4be8325384b6e8a63f05fcb3.png)  
我们一般称原语的简写为：  
Wait（S）—P操作P（S）  
Signal（S）—V操作V（S）  
...
![在这里插入图片描述](./assets/f0b83621bdd7a3cd5da030a1.png)  
...
![在这里插入图片描述](./assets/ce0e6f9472e9630bd61b97b8.png)

3.信号量机制实现前驱关系  
![在这里插入图片描述](./assets/3bdc8646b218580829d79e3b.png)
