...
存储器太重要了兄弟们，计算机想要自动执行程序（指令和数据），就必需有存储器来记忆，并且可以被译码器自动读取到。  
 ...
 ![在这里插入图片描述](./assets/126671877/b71e9e95cd542f7b45bf1bec.png)
...
存储器裂开可不是简单的裂开，只可谓裂的恰到好处，简单来说分3层：  
 ...
 ![在这里插入图片描述](./assets/126671877/fcbd5d65b8e3247f1f6c6fd2.png)  
...
简单介绍：  
 ...
 ![在这里插入图片描述](./assets/126671877/4fe934be5f561f1b5539ff2e.png)
...
**为什么出现动态运行装入方式？**  
 ...
 缺点：  
 需要硬件支持（贵东西的缺点就是鬼）  
 ![在这里插入图片描述](./assets/126671877/1ec64b548d626e72072be188.png)
...
当内存空间不足或进程需要的空间大于能提供的空间时，系统如何满足进程的请求呢？  
 ![在这里插入图片描述](./assets/126671877/79ef4ee1f325d22c644fa87c.png)  
...
![在这里插入图片描述](./assets/126671877/3abd2241808ef6b44cba39aa.png)
...
单道环境下，早起存储器管理方式是把内存分为系统区（仅供os使用，放在内存地址部分）和用户区（仅有一道用户程序）两部分。  
 ![在这里插入图片描述](./assets/126671877/64bbd8036bb4c92c5b9e070a.png)
...
目的：为了使内存中装入多道程序，且程序之间互不干扰。  
 ...
 ![在这里插入图片描述](./assets/126671877/8924974aeb36a781014aeaa9.png)  
 内存分配：  
 按分区的大小进行排队，并为之建立一张固定分区使用表（包含每个分区起始地址，大小及状态![在这里插入图片描述](./assets/126671877/c204ce2f57a1871d828d5ed0.png)
...
问题：系统要用什么样的数据结构记录内存的使用情况呢？  
 ...
 ![在这里插入图片描述](./assets/126671877/07467e8e6f23d7a193d97a44.png)  
 ![在这里插入图片描述](./assets/126671877/da646cb2e418a1d577e944ee.png)  
