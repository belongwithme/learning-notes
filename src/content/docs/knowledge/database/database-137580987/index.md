...
下面根据对应的页面,进行分析  
 ![在这里插入图片描述](./assets/8be43810cea0c5d5752c3d74.png)  
 条件筛选: 方向,分类,难度  
 课程信息(列表页): 主标题,副标题,图标,学习人数,学习难度.  
 ![在这里插入图片描述](./assets/a12b069b3f3944db7aaa8a7b.png)  
 课程信息(详情页): 学习难度,时长,学习人数,中和评分,讲师等信息  
 课程信息(章节列表): 名称,说明,小节名称,小节时长.

![在这里插入图片描述](./assets/3a5ae43728414a6bc37a49d8.png)  
 讲师信息(点击讲师信息后的页面):  
 性别,省份,职业,描述,经验,积分,关注,粉丝,讲师所讲课程列表.  
 ![在这里插入图片描述](./assets/10670d05810381b380e0f7e5.png)  
 问答评论:  
 评论类型: 评论,问答,未解决,精华标识信息;  
 问答标题,浏览数量,关联章节信息等.

![在这里插入图片描述](./assets/0e4bbff3eeba30582f63f104.png)  
 同学笔记: 昵称(用户信息),关联章节,内容,发布时间等信息  
 ![在这里插入图片描述](./assets/4fd782a42fc709892778d95e.png)  
 和讲师信息类似

![在这里插入图片描述](./assets/18d819835f90091968141355.png)  
...
![在这里插入图片描述](./assets/ffee69e3cd3580943e061cd7.png)
