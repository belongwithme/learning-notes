...
7. 按照排序结果取前 1000 行返回给客户端。  
    用示意图来表示如下:  
    ![在这里插入图片描述](./assets/6eb2be25dc9ce9192a16183b.png)  
...
这个方法是通过查看 OPTIMIZER\_TRACE 的结果来确认的，你可以从 number\_of\_tmp\_files 中看到是否使用了临时文件。  
 ![在这里插入图片描述](./assets/ef18fa94c7ad22da92b6912f.png)  
...
7. 遍历排序结果，取前 1000 行，并按照 id 的值回到原表中取出 city、name 和 age 三个字段返回给客户端。  
    ![在这里插入图片描述](./assets/d5dac1a1103d5404f833d160.png)  
...
![在这里插入图片描述](./assets/1d149ade0d523328eea292e6.png)  
 这样整个查询过程的流程就变成了：
...
4. 重复步骤 2、3，直到查到第 1000 条记录，或者是不满足 city=‘杭州’条件时循环结束。  
    ![在这里插入图片描述](./assets/b87495dabff8e58864812ba8.png)  
    最后用explain来印证一下:  
    ![在这里插入图片描述](./assets/963ed8a4b2db157d45f3b2a9.png)  
