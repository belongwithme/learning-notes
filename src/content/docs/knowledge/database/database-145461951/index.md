...
如果表里只有主键索引，没有二级索引时，那么，InnoDB 循环遍历聚簇索引，将读取到的记录返回给 server 层，然后读取记录中的 id 值，就会 id 值判断是否为 NULL，如果不为NULL,就将count变量+1.  
 ![在这里插入图片描述](./assets/671d74928584c41ff4c4cf55.png)  
 但是如果表中有二级索引,那么InnoDB 循环遍历的对象就不是聚簇索引，而是二级索引.  
 ![在这里插入图片描述](./assets/1f1a1a5392c441893a0bfa16.png)  
...
表里只有主键索引,没有二级索引时:  
 ![在这里插入图片描述](./assets/b96812a2f43a64992b4b4016.png)  
 ...
 ![在这里插入图片描述](./assets/e6692662249172b659f11ced.png)
