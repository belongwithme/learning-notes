...
数据页包括七个部分，结构如下图:  
 ![在这里插入图片描述](./assets/c9e73380c8f00cab5989378e.png)  
 这 7 个部分的作用如下图：  
 ![在这里插入图片描述](./assets/04739d04d154146658a571a1.png)  
 在 File Header 中有两个指针，分别指向上一个数据页和下一个数据页，连接起来的页相当于一个双向的链表，如下图所示：  
 ![在这里插入图片描述](./assets/044668a6ba582f67780892e6.png)  
...
数据页的主要作用是存储记录，也就是数据库的数据,所以重点说一下数据页中的 User Records 是怎么组织数据的。  
 ...
 ![在这里插入图片描述](./assets/68c1c2ddd9e3ede248c44590.png)  
 页目录创建的过程如下：
...
为了方便定位记录所在的页,InnoDB使用了B+数作为索引.  
 ...
 ![在这里插入图片描述](./assets/6bca494e16dcf1973327a5be.png)  
 通过上图可以发现B+树特点:
