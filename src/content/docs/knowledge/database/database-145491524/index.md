...
![在这里插入图片描述](./assets/c674bf7013975ba99a260f23.png)  
...
我们创建的索引如下:  
 ![在这里插入图片描述](./assets/abfe8a653f6bfa733b35075a.png)
...
explain结果：  
 ![在这里插入图片描述](./assets/dbeb6633cdeb94e352eccdda.png)  
...
explain结果：  
 ![在这里插入图片描述](./assets/fc996dfdefcca161c92efc16.png)  
...
explain结果：  
 ![在这里插入图片描述](./assets/78b0f6d81756c768b5402a87.png)  
...
explain结果：  
 ![在这里插入图片描述](./assets/d16170baa3b4e7e44933ee64.png)  
...
explain结果：  
 ![在这里插入图片描述](./assets/9c15ef98ff6689f4291c7f98.png)
...
explain结果：  
 ![在这里插入图片描述](./assets/564ec1df195cda1cfa7dd9b9.png)  
 无论查询条件是username还是age，都走了索引，根据key\_len可以看出使用了索引的所有列。

我们换成\*号  
 第一条explain执行:  
 ![在这里插入图片描述](./assets/af9763d952fd9119c53ae343.png)  
 第二条explain执行:  
 ![在这里插入图片描述](./assets/3855a215ebd521e0e2a98bf5.png)  
 可以看到他们都没有走索引  
 .  
 但是看到这里你是不是有个疑问呢?
...
首先我们的索引如下:  
 ![在这里插入图片描述](./assets/b566ad9ef007c84b44478707.png)  
...
![在这里插入图片描述](./assets/e6f106177356edda42e612a7.png)  
...
下面只分析一种,另外一条同理,explain如下:  
 ![在这里插入图片描述](./assets/13df22cd85759e800f78580f.png)
...
![在这里插入图片描述](./assets/b4e50d8fa22c5f44a4811beb.png)  
...
explain结果:  
 ![在这里插入图片描述](./assets/098f523fbbf0af322ca46d2f.png)  
 ...
 ![在这里插入图片描述](./assets/c78d2b97d145365b72e1d220.png)
...
![在这里插入图片描述](./assets/54a2dbe69ef79bcca3e9b2e4.png)  
...
下图可以看出是走索引了的:  
 ![在这里插入图片描述](./assets/69ae2fd544e19cc933772c50.png)
...
explain结果：  
 ![在这里插入图片描述](./assets/49186d2c004a3728143f3fec.png)明明id字段是有索引的，由于使用or关键字，索引竟然失效了。  
 ...
 ![在这里插入图片描述](./assets/f9f8b3c51c216c3bb1a49c1b.png)  
 发现现在是有索引了.
...
explain结果：  
 ![在这里插入图片描述](./assets/25b9a59368c93619b3518240.png)
...
explain结果：  
 ![在这里插入图片描述](./assets/6498baf5d77a871700995b9c.png)  
...
explain结果：  
 ![在这里插入图片描述](./assets/42626fc5fc79c1621866b6be.png)  
...
![在这里插入图片描述](./assets/786e25e9754584467394ff04.png)  
...
explain结果：  
 ![在这里插入图片描述](./assets/d53ac607a67b4bd6ad131d8c.png)  
...
explain结果：  
 ![在这里插入图片描述](./assets/42885a6d02230db9e4918228.png)  
...
explain结果：  
 ![在这里插入图片描述](./assets/30e53f6f52f5a2a19de08eb4.png)  
...
explain结果：  
 ![在这里插入图片描述](./assets/4c9941e7661d23fbd75e1736.png)  
...
explain结果：  
 ![在这里插入图片描述](./assets/eb93a733cff993bab2410d9d.png)  
...
explain结果：  
 ![在这里插入图片描述](./assets/a2f2e2bfa2d9556b808c6566.png)  
...
explain如下:  
 ![在这里插入图片描述](./assets/171395a1da45368d97986950.png)  
...
explain结果:  
 ![在这里插入图片描述](./assets/688ceba03d1337834fdcf539.png)
