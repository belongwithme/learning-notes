---
title: "读写分离架构下的一致性挑战"
description: "读写分离架构是一种常见的数据库架构，它将数据库分为读数据库和写数据库."
sourceId: "146005123"
source: "https://blog.csdn.net/qq_45852626/article/details/146005123"
sourceSeries: []
...
> 原文：[CSDN](https://blog.csdn.net/qq_45852626/article/details/146005123)（历史文章导入，当前状态为草稿）
...
原理：不直接
存储 
实体的当前状态，而是存储导致状态变化的所有事件，通过重放事件流来重建实体状态。
...
超时机制：  
 设置rpl\_semi\_sync\_master\_timeout参数控制等待超时  
