...
将用户相关的表放入user\_db，订单相关的表放入order\_db，商品相关的表放入product\_db。  
 ![在这里插入图片描述](./assets/46dfbff0c9708d6b96a2b66f.png)
...
![在这里插入图片描述](./assets/0f3dde499c3357a727743043.png)  
 **切分后的工作流程：**
...
**切分前**  
 ![在这里插入图片描述](./assets/efc34c9edee7c16bf3e75ab1.png)  
 **切分后**  
 ![在这里插入图片描述](./assets/c02b61a272cb1899b6e6cfd0.png)  
 **图示解读：**
...
![在这里插入图片描述](./assets/db9021400d08a487a8e52eea.png)
...
下图展示了3个服务器节点（Node A, B, C）和4个数据键（Key 1-4）在哈希环上的分布与归属关系。  
 ![在这里插入图片描述](./assets/5e41fd902942e712f8295378.png)
...
此图演示了当我们在 Node B 和 Node C 之间增加一个新节点 Node D 时，数据路由和迁移是如何发生的。  
 ![在这里插入图片描述](./assets/67e890e7487fcae88e6b161f.png)  
 **场景二：移除一台服务器 (Node B)**  
 假设 Node B 因为故障下线了。
...
![在这里插入图片描述](./assets/8a51cf7ec6d5362d00953bca.png)
...
![在这里插入图片描述](./assets/b87296f40d370c34eaf71f07.png)
...
![在这里插入图片描述](./assets/423b0f02fc97ed850d91edc2.png)
...
![在这里插入图片描述](./assets/f5f2bcdc9379b1741bac8a9e.png)
...
![在这里插入图片描述](./assets/0ef45c34873427e7064fbb72.png)
