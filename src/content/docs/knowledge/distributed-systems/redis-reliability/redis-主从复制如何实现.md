...
* 如果这台服务器的硬盘出现了故障，可能数据就都丢失了。  
   ...
   ![在这里插入图片描述](./assets/145807906/4f9212d8dc1e3c2466d1123a.png)  
...
主从服务器之间采用的是「读写分离」的方式.  
 ...
 ![在这里插入图片描述](./assets/145807906/104039ace5f5a1ed1b49ee32.png)  
...
* 第三阶段是主服务器发送新写操作命令给从服务器。  
   过程如下图:  
   ![在这里插入图片描述](./assets/145807906/cc031b35ca93f558f3727af0.png)  
...
主从服务器在完成第一次同步后，双方之间就会维护一个 TCP 连接。  
 ![在这里插入图片描述](./assets/145807906/e77e665bb73561f81025609e.png)  
...
* 传输RDB文件会占用主服务器的网络贷款,会对主服务器响应的命令请求产生影响.  
   ...
   ![在这里插入图片描述](./assets/145807906/af21314b3fa2e37fc821565e.png)  
...
客户端 
就可能从「从服务器」读到旧的数据。  
 ![在这里插入图片描述](./assets/145807906/a72d405533e0b55da73c2b37.png)  
 ...
 网络恢复后的增量复制过程如下图:  
 ![在这里插入图片描述](./assets/145807906/c225db9c3444dfa6d567cf0a.png)  
 主要是三个步骤:
...
缓存 
将要传播给从服务器的命令。  
 ![在这里插入图片描述](./assets/145807906/b00ddc80db4f8ce1187bb7cf.png)  
 ...
 ![在这里插入图片描述](./assets/145807906/d7b6601f75c552f6ede3f5d3.png)  
 我来解释下这个公式的意思：
