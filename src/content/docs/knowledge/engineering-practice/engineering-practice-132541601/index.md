...
操作如下图所示  
 ![在这里插入图片描述](./assets/e891f4fd54e6864def59b267.png)
...
![在这里插入图片描述](./assets/7d4ae0bdbb633e454681b74e.png)  
 然后就大功告成!!!  
 ![在这里插入图片描述](./assets/382809883b316f50913c9f6a.png)
...
在导航栏中找到identity/user处创建一个用户，点击create user按钮  
 ![在这里插入图片描述](./assets/d93f168be220f844dae8147e.png)

### 2. 设置用户信息

用户名密码以及权限写完之后，就可以使用该用户登录MinIO控制台了。  
 ![在这里插入图片描述](./assets/9819b1f42a8b155827bb7625.png)  
 创建用户之后，点击用户弹出用户的基本信息，点击导航栏中的`Service Accounts`，出现下面的界面

![在这里插入图片描述](./assets/70323cd6dfc435f47513a792.png)  
 点击右边的`Create Access Key`，系统会随机生成`Create Access Key`，点击create按钮后，会展示出它们的信息，**这时记得将它们复制粘贴到你的笔记或者存储文件中，后续使用代码上传文件时需要用到这两个key。**  
 ![在这里插入图片描述](./assets/4326414ee2bd0ebfe04e0d64.png)

### 3. 创建一个桶

在页面导航栏中找到`Administrator/Buckets`，点击右上角创建桶按钮  
 ![在这里插入图片描述](./assets/fca32570ed148c0e12fc0139.png)  
 然后输入桶的名字，就大功告成了！  
 ![在这里插入图片描述](./assets/726bc5db499bceac6fb77bd0.png)
...
结果如下：  
 ![在这里插入图片描述](./assets/d8f52b6d1cf4ea654792834f.png)
...
注意：桶的创建时间默认是美国时间，创建桶时我们可以指定桶的时区或者设置 MinIO服务器时区。  
 结果如下：  
 ![在这里插入图片描述](./assets/e55ffee33e4eddc675fc2e32.png)
...
结果如下：  
 ![在这里插入图片描述](./assets/65a2678e273bc71ad9d831c7.png)  
 **需要注意几个点：**
...
结果如下：  
 ![在这里插入图片描述](./assets/908a52f32c1d3905d11fb171.png)
...
结果  
 ![在这里插入图片描述](./assets/f33726d0cabd621b0b69b30c.png)
...
结果：  
 ![在这里插入图片描述](./assets/335dbccd3f03a81248d43516.png)
...
结果如下：  
 ![在这里插入图片描述](./assets/f7dd809db7d7bd7f12dc130c.png)
...
结果如下：  
 ![在这里插入图片描述](./assets/aea136d38065c96545bc87e0.png)
...
结果如下：  
 ![在这里插入图片描述](./assets/bf146950e558ce57ec19c374.png)
...
结果如下：  
 ![在这里插入图片描述](./assets/146b415cde58f567aa5baa8b.png)
...
结果如下：  
 ![在这里插入图片描述](./assets/966174f694c34436083cce58.png)
...
![在这里插入图片描述](./assets/4eceafa6232fa156a6bd05f2.png)
