...
1. 在单核时代，所有线程都在一颗CPU执行，CPU缓存与内存的数据一致性很容易解决，因为所有线程操作都是同一个CPU的缓存，一个线程对缓存写，另一个线程一定可以看到。  
    ![在这里插入图片描述](./assets/126028285/97efd9046259189e6908e6dc.png)

而对于一个线程对共享变量的修改，另外一个线程能够立刻看到，我们成为可见性。

2. 在多核时代，每颗CPU都有自己的缓存，当多个线程在不同CPU执行时，这些线程操作的是不同的CPU缓存。  
    ![在这里插入图片描述](./assets/126028285/30b9ed5ba4100a20da8aeb26.png)  
...
![在这里插入图片描述](./assets/126028285/5d9aeab6373a23a5db128fc5.png)  
...
有一个鱼罐头的故事和你分享：  
 ...
 杀菌出锅：10分钟  
 真空封罐：10分钟  
 ![在这里插入图片描述](./assets/126028285/1ed1dcaf871de4f0e1717765.png)  
 即使只有一个工人，最理想的情况：他能够在10分钟之内同时做好5件事，因为对第一条鱼的真空装罐，不会影响第二条鱼的杀菌出锅。  
 ![在这里插入图片描述](./assets/126028285/7cd089016a25c52c62d10105.png)  
 ...
 ![在这里插入图片描述](./assets/126028285/6e819772b605cf5659d7f5f1.png)  
 那么它有什么用呢？  
 ...
 ![在这里插入图片描述](./assets/126028285/a8b9e82fc11332ce9e581856.png)  
