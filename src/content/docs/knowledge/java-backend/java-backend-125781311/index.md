...
的环境下。  
二：继承关系  
![在这里插入图片描述](./assets/369a93a76aa8d410d9fb12ad.png)  
代码实现：
...
![在这里插入图片描述](./assets/4a55d5f4df88676c98c1f3b3.png)  
运行到11行，准备进行扩容：  
![在这里插入图片描述](./assets/6be6019c2b62845bfdc00e46.png)  
进入add代码里：
...
![在这里插入图片描述](./assets/6cc2fe2e1bef4805243149fb.png)  
进入ensureCapacityHelper(elementCount + 1)方法：  
![在这里插入图片描述](./assets/9cf05354ef7dc934f1e71bc5.png)  
这里进入if判断，minCapacity为11，element.length为10，所以进入if方法块,执行grow方法：

![在这里插入图片描述](./assets/3f8a3c90bfcd220699053a54.png)  
执行完后完成扩容：  
![在这里插入图片描述](./assets/0f9b3339f8452d2a84200746.png)  
最后完成赋值：  
![在这里插入图片描述](./assets/97b9792877a3dea331ee0557.png)
