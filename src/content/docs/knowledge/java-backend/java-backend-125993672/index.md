...
![在这里插入图片描述](./assets/ce9f706fb0418d00519d9ad1.png)  
 代码实现：
...
![在这里插入图片描述](./assets/198137c166c3dc4cd26f95c1.png)
...
这个方法通常用Runnable启动线程的方法，实际上Runnable对象被放置在了target变量中，之后通过jvm启动线程![在这里插入图片描述](./assets/35344b4ed1a1c8261be2d261.png)
...
传入Runnable同时也可以指定AccessControlContext（根据其封装的上下文做出系统资源访问决策。）  
 ![在这里插入图片描述](./assets/632d4c5c338699fab3dbec67.png)
...
![在这里插入图片描述](./assets/0d1055e10f0cf6d29678d5c4.png)  
 使用线程组。  
...
![在这里插入图片描述](./assets/d4dd0abadd6d0ac68b062ae6.png) 指定线程的名称
...
![在这里插入图片描述](./assets/7207a0ed1619cfabb0c1b88e.png)
...
![在这里插入图片描述](./assets/0d1dc93543d01f4e6b8b5f7c.png)
...
![在这里插入图片描述](./assets/b67ac24609cb7ffe0cfe3d04.png)
...
![在这里插入图片描述](./assets/85591ee36749fcb710fca128.png)
...
![在这里插入图片描述](./assets/3d78534ab7b0835ffe4b1b1f.png)  
