...
在架构设计中，**认证**和**授权**是分开的，两个是独立的存在，好处在于可以非常方便的整合一些外部的解决方案。  
 ![在这里插入图片描述](./assets/33429b6c31464364f9642ce4.png)  
 下面我们对于里面的细节做一些基本的了解。
...
1.创建springboot单体项目  
 ![请添加图片描述](./assets/9409004ed809c32b8b494ea1.png)  
 2. 创建controller  
 项目结构：  
 ![请添加图片描述](./assets/3d59bd1352328e9f34262e60.png)  
 项目代码：
...
3.启动项目测试  
 ...
 ![在这里插入图片描述](./assets/40bbb8c497fdc78573316719.png)
...
* 启动后控制台生成一个密码
* 访问hello发现直接跳转到登陆页面  
   ![请添加图片描述](./assets/ae84320f5150090025ab7be9.png)  
   ![在这里插入图片描述](./assets/f323c0724c015fa862255bdf.png)  
   3.登陆系统
* 默认用户名：user
* 默认密码：控制台打印的uuid  
   ![请添加图片描述](./assets/3568c364b6f39794fa40ab1c.png)
...
假设我们现在不用Spring Security，自己去开发一个权限管理，我们应该如何做权限管理？  
 ...
 那么我们的设计思路应该如下图所示：![请添加图片描述](./assets/ea0172a1bcf3e56a5d33ab4f.png)提供一个官方的网址来参考：`https://docs.spring.io/spring-security/site/docs/5.5.x-SNAPSHOT/reference/html5/#servlet-architecture`
...
![图一：过滤链](./assets/cdd61acffe0826b2711d33b2.png)
...
这是DelegatingFilterProxy如何与过滤器和FilterChain相结合的示意图，如下图：  
 ![在这里插入图片描述](./assets/79096e77910586ad155d483c.png)
...
下图展示了FilterChainProxy的信息：  
 ![在这里插入图片描述](./assets/922b1f5afd41abc084d41546.png)
...
如下图所示：  
 ![在这里插入图片描述](./assets/ced02f8fcac186f666c40c21.png)
...
![在这里插入图片描述](./assets/7a5b1823f5244cdaf7a66b7e.png)
...
![请添加图片描述](./assets/da4ec064ce665872830b1e66.png)
