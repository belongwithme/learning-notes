...
![在这里插入图片描述](./assets/abc9a8cd06eb18c33aaaf4ba.png)  
 还有个扩展图:

![](./assets/406f50d1c53835efffdc9dd9.png)
...
自定义非受检异常  
 ![在这里插入图片描述](./assets/8e463d1599e1a6589555bf9e.png)
...
![在这里插入图片描述](./assets/d3d48057b61899bb3d28ee5b.png)  
 **前置知识:**  
...
下面我们根据几个案例来深入理解  
 **案例一: try-catch 字节码分析**  
 ![在这里插入图片描述](./assets/6d3181e139feb83dc6e490f7.png)  
 这里我们先说明athrow指令的作用:  
 ![在这里插入图片描述](./assets/d5999ef0b8765754ff4bc214.png)  
 **athrow指令**  
...
**异常表**  
 ...
 ![在这里插入图片描述](./assets/e88b7f59efbf8e6ebd3f31b9.png)
...
**案例二: try-catch-finally 字节码分析**  
 ![在这里插入图片描述](./assets/18ef0e25f5a17b249fff12e4.png)  
 异常表信息如下:  
 ![在这里插入图片描述](./assets/1ed72f86568f4bac5ee1feb4.png)  
...
**案例三: finally 块中的代码为什么总是会执行**  
 ![在这里插入图片描述](./assets/76bacca88cdb6a35aab135d9.png)  
 异常表:  
 ![在这里插入图片描述](./assets/b1e028f7f357068e63154f0a.png)  
 我们来简单分析一下上面代码的字节码指令:  
...
我们先分析一下getInt()方法的字节码:  
 ![在这里插入图片描述](./assets/d9d2cffed223ac2c81ff1869.png)  
 局部变量表:  
 ![在这里插入图片描述](./assets/b8f69251df85d623ad2ca5c8.png)  
 异常表:  
 ![在这里插入图片描述](./assets/8400b0e7e394f4c3fc2526e2.png)  
 我们可以看出,如果finally块中有return关键字,那么try块以及catch块中的return都会失效,所以开发过程中不应该在finally块中写return语句.

再分析一下getInt2()方法的字节码:  
 ![在这里插入图片描述](./assets/96632462f0e5d7a212c5d483.png)  
 异常表:  
 ![在这里插入图片描述](./assets/f96a8c23054d157a0c5fcf23.png)  
...
* 系统异常:用户看不懂需要程序员处理的异常.比如网络连接超时,需要程序员排查.  
   下面给出应用程序中异常体系分类:  
   ![在这里插入图片描述](./assets/1c56c2560df7b360e2b8982d.png)  
