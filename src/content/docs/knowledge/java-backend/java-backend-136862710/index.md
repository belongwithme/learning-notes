 ...
 **什么是声明式编程**  
 ...
 ![在这里插入图片描述](./assets/2ca57445fc4e72538c85109b.png)
...
* 创建Stream
* Stream中间处理
* 终止Stream![在这里插入图片描述](./assets/057f81acbfe5ac3f5898db54.png)  
...
* flatmapkey是一对多的,即每个元素都可以转换为一个或者多个新的元素.  
   ![在这里插入图片描述](./assets/fc8d4dedddfb79e9f696b215.png)  
...
为一个新的完整的stream,如下图所示:  
 ![在这里插入图片描述](./assets/02aadfa256259d346d0b1575.png)
