...
JVM可以理解的代码为字节码(扩展名为.class的文件),它不面向任何特定的处理器,只面向虚拟机.  
 ...
 ![](./assets/a48ec562a14753ab14e177b6.png)  
...
第一行代码会发生装箱,也就说这行代码等价于`Integer A = Integer.valueOf(40)`.  
 ...
 所以答案是false/  
 ![在这里插入图片描述](./assets/89cdaa02e0ff9b750aba6519.png)
...
![在这里插入图片描述](./assets/ad427cc15eb56f0d62cadd65.png)

#### Java中是值传递还是引用传递,还是两者共存

Java传递的只有值  
 执行方法时,会将方法的栈帧压入栈内存,但是栈帧中的变量不会相互影响.  
 ![在这里插入图片描述](./assets/c3a26b6f918baa800eb4d307.png)
