...
* 普普通通创建一个Java bean：  
   ![在这里插入图片描述](./assets/128748042/dc36ac5475635ea3b710aae9.png)
* Spring创建Bean：  
   ![在这里插入图片描述](./assets/128748042/99e0a790e05196ed10f513f9.png)

![在这里插入图片描述](./assets/128748042/ee7facde18b1fc002b9d2a10.png)
